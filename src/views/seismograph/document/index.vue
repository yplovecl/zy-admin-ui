    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="documentRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="系列名称" prop="equipmentSeries">
          <el-input v-model="form.equipmentSeries" placeholder="请输入系列名称" maxlength="50" show-word-limit/>
        </el-form-item>
        <el-form-item v-if="type !== 1" label="设备ID" prop="equipmentIdentity">
          <el-input v-model="form.equipmentIdentity" placeholder="请输入设备ID" maxlength="30" show-word-limit/>
        </el-form-item>
        <el-form-item label="文档名称" prop="documentName">
          <el-input v-model="form.documentName" placeholder="请输入文档名称" maxlength="50" show-word-limit/>
        </el-form-item>
